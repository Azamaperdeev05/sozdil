    ...
    <div className="flex items-center space-x-0.5 sm:space-x-1.5">
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <path d="M4 22h16" />
          <path d="M10 14.66V17c0 .55-.45.98-.98 1.05A6 6 0 0 1 6 12V4h12v8a6 6 0 0 1-3.02 5.05c-.53-.07-.98-.5-.98-1.05v-2.34" />
        </svg>
      </button>
      ...
      <button
        ...
        className="p-1.5 sm:p-2 min-w-[36px] sm:min-w-[40px] min-h-[36px] sm:min-h-[40px] flex items-center justify-center rounded-full hover:bg-surface transition-colors"
      >
