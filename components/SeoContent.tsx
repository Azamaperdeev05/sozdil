...
const FAQ_ITEMS: FaqItem[] = [
  {
    ...
    a: 'Сөзділ (кейде қолданушылар «Создил», «Wordle на казахском» деп іздейді) — әлемге әйгілі Wordle ойынының қазақ тіліндегі ресми әрі толыққанды аналогы. Мұнда ойыншылар 4, 5 және 6 әріптен тұратын жасырын сөзді 6 мүмкіндікте табуы қажет. Ойын қазақ тілінің сөздік қорын байытуға, есте сақтау қабілеті мен логикалық ойлауды шыңдауға көмектеседі.',
  },
  {
      ...
      <div className={`${isOpen ? 'block' : 'hidden'} mt-4 space-y-4 text-xs text-muted leading-relaxed`}>
        ...
        <div className="bg-surface/50 border border-border/70 rounded-xl p-3.5 space-y-2">
          <h3 className="font-bold text-text text-sm">
            Сөзділ (Создил) — Қазақ тіліндегі күнделікті сөз табу ойыны
          </h3>
          <p>
